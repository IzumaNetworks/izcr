...
import (
	...
	"go.izuma.io/izcr/health"
	"go.izuma.io/izcr/health/checks"
	"go.izuma.io/izcr/internal/dcontext"
	prometheus "go.izuma.io/izcr/metrics"
	"go.izuma.io/izcr/notifications"
	"go.izuma.io/izcr/registry/api/errcode"
	v2 "go.izuma.io/izcr/registry/api/v2"
	"go.izuma.io/izcr/registry/auth"
	registrymiddleware "go.izuma.io/izcr/registry/middleware/registry"
	repositorymiddleware "go.izuma.io/izcr/registry/middleware/repository"
	"go.izuma.io/izcr/registry/proxy"
	"go.izuma.io/izcr/registry/storage"
	memorycache "go.izuma.io/izcr/registry/storage/cache/memory"
	rediscache "go.izuma.io/izcr/registry/storage/cache/redis"
