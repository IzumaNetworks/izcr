...
30. Update the version file: `https://go.izuma.io/izcr/blob/master/version/version.go`
...
60. Create a new [release](https://go.izuma.io/izcr/releases).
In the case of a release candidate, tick the `pre-release` checkbox. Use
the generate release notes from the release tool

70. Update the registry binary in the [distribution library image repo](https://go.izuma.io/izcr-library-image) by running the update script and  opening a pull request.
